app.directive('wpContainer', ['blocks','routing','partials','$compile','$timeout', function(blocks,routing,partials,$compile,$timeout) {
	var priority = 1000;
	...
	return {
		...
		link: function (scope, element, attrs) {
			var showing = [];
			var params = {location:attrs['wpContainer'],layout:'single'};
			try {
